...
namespace ConsoleApp2
{
    class Program
    {
        ...
        private static void NewMethod(string name, string value, string value1)
        {
        ...
        public static void ReadFile()
        {
            ...
            string file = "D:/eDOSToSQL/测试/eDOS数据库连接信息.txt";
            if (!File.Exists(file))
            {
            ...
            WriteLog("开始读取点表配置文件");
            string file1 = "D:/eDOSToSQL/测试/点表配置文件.txt";
        ...
        public static void WriteLog(string message)
        {
            try
            {
                string filed = @"D:\eDOSToSQL\测试\calcLog.txt";
